...
public class Battle {
    ...
    public int MonsterFight(Card user1Card, Card user2Card){
        ...
        else if(user1Card.getMonpackage com.example.mtcg;
import com.example.mtcg.card.*;
        ...
        sterType().equals(MonsterType.ELVE) && user1Card.getType().equals(ElementType.FIRE) && user2Card.getMonsterType().equals(MonsterType.DRAGON)){
